...
public class RegisterClientController {
    ...
    @FXML
    private TextField name_text,email_text,username_text,id_card_text,tel_text;
    @FXML
    ...
    public boolean check_ID_number(){
        for(int i =0; i < id_card_text.getText().length() ; i++ ){
            if(!Character.isDigit(id_card_text.getText().charAt(i))){
                return false;
            }
        }
        if(id_card_text.getText().length() != 13){
            return false;
        }
        return true;
    }
    ...
    public boolean checkText_field(){
        if(name_text.getText().equals("")|| email_text.getText().equals("")|| username_text.getText().equals("")|| id_card_text.getText().equals("")|| tel_text.getText().equals("")|| pass_text.getText().equals("")|| conpass_text.getText().equals("")|| date_pick.getValue() == null){
            return true;
        }
        return false;
    }
