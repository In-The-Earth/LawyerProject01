...
public class RegisterClientController {
    ...
    public boolean checkText_field(){
        if(name_text.getText().equals("")|| email_text.getText().equals("")|| username_text.getText().equals("")|| id_card_text.getText().equals("")|| tel_text.getText().equals("")|| pass_text.getText().equals("")|| conpass_text.getText().equals("")|| date_pick.getValue().toString().equals("")){
            return true;
        }
        return false;
    }
